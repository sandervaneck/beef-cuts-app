  ...
  return (
    ...
    >
      ...
      <g
        ...
        style={{ display: "inline" }}
        transform="translate(-7.6941642,10.065285)"
        data-inkscape-label="Cadre"
        data-inkscape-groupmode="layer"
        data-sodipodi-insensitive="true"
      >
        <g
          id="g4009"
          transform="translate(-2.6971997,-1.3169604)"
...
const PathForId: React.FC<PathProps> = ({id, d, transform, selectedCutId, onCutHover}) => {
  return <path
          id={id}
          d={d}
          fill={selectedCutId===id ? "#FF6A13" : "#f51633"}
          fillOpacity={1}
          transform={transform}
          stroke="#000000"
          strokeWidth={1.00000012}
